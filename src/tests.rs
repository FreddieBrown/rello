...
fn test_create_remove_item() {
    ...
    config.create_item(String::from("TestItemTitle1"), String::from("TestItemBody1"), None, String::from("ToDo"));
...
fn test_create_remove_item_with_assignee() {
    ...
    config.create_item(String::from("TestItemTitle1"), String::from("TestItemBody1"), Some(String::from("TestAssignee1")), String::from("ToDo"));
